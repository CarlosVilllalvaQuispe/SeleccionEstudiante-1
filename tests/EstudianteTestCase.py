...
class EstudianteTestCase ( unittest.TestCase ) :
    ...
    def test_agregar_estdudiante ( self ) :
        resultado = self.sorteo.agregar_estudiante ( apellidoPaterno = "Villalva" , apellidoMaterno = "Quispe" , nombres = "Carlos" ,
                                   elegible = True )
        self.assertEqual ( resultado , True )

    def test_agregar_estdudiante_repetido(self):
        resultado = self.sorteo.agregar_estudiante(apellidoPaterno="Ramos", apellidoMaterno="Ortega",
                                                   nombres="Juan Carlos",
                                                   elegible=True)
